    ...
    <main class="main">
        <div class="box-card">
            ...
            <div class="text2" >
                ...
                <div style="text-align: left" v-for="item in author" :key="item.authorid">姓名：{{item.name}} 微信号：{{item.wxnumber}}</div>
            </div>
        </div>
  ...
  export default {
    name: 'About',
      ...
      mounted() {
        ...
        body[0].style = 'width: 100vw;height: 100vh;perspective: 100px;transform-style: preserve-3d;overflow-y: auto;margin: 0;padding: 0;';
