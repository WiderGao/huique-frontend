<template>
  <div class="app">
    <div class="box">
      ...
      <form id="form">
        <div class="inputBox">
          <input v-model="phone" type="text" name="phone" id="phone" required=""></input>
          <label>手机号</label>
        </div>
        <div class="inputBox">
          <input v-model="password" type="password" name="password" id="password" required=""></input>
          <label>密码</label>
        </div>
        <div class="inputBox">
          <input v-model="checkpassword" type="password" name="checkpassword" id="checkpassword" required=""></input>
          <label>重复密码</label>
        </div>
        <div class="inputBox">
          <input v-model="username" type="text" name="username" id="name" required=""></input>
          <label>姓名</label>
        </div>
        <input type="submit" @click.prevent="Submit" value="注册账户"></input>
      </form>
